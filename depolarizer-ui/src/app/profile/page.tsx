...
const getStanceColor = (stance: string | null) => {
    ...
    if (["far-left", "left-leaning", "moderate-left", "left", "center-left", "progressive"].includes(normalized)) return "#2563EB";
    if (["moderate-right", "right-leaning", "far-right", "right", "center-right", "conservative"].includes(normalized)) return "#DC2626";
    return "#8B5CF6";
};
